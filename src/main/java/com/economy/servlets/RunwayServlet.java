...
@WebServlet(name = "RunwayServlet", urlPatterns = {"/users/runway"})
public class RunwayServlet extends BaseSV {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("/runway/runway.jsp").forward(req, resp);
    }
}
